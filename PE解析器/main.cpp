...
int  WinMain( HINSTANCE hInstance,HINSTANCE hPrevInstance,LPSTR  lpCmdLine,int nShowCmd)
{
  ...
  /*  wc.hIcon = (HICON)LoadImageW(
   ...
   /* wc.hIconSm = (HICON)LoadImageW(
    ...
    ::RegisterClassExW(&wc);
    HWND hwnd = ::CreateWindowW(wc.lpszClassName, L"PE解析器", style, 100, 100, (int)(1000), (int)(670), nullptr, nullptr, wc.hInstance, nullptr);
    ...
    io.IniFilename = nullptr; // 禁用 imgui.ini 的加载/保存（不会生成文件）
